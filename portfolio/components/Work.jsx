...
const Work = () => {
  return (
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am a frontend developer from Sydney, Australia with 4 years of experience in multiple companies like Microsot, Telsa and Apple.</p>
      ...
      <div className='grid grid-cols-auto my-10 gap-5'>
         {workData.map((project, index)=>(
           <div className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group' key={index} style={{backgroundImage : `url(${project.bgImage})`}}>
            ...
            <div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center duration-500 group-hover:bottom-7'>
            <div>
