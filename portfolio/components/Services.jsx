...
const Services = () => {
  return (
    <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt5q mb-12 font-Ovo'>I am a frontend developer from Sydney, Australia with 4 years of experience in multiple companies like Microsot, Telsa and Apple.</p>
